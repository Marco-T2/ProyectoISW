...
namespace ProyectoISW
{
    public partial class PlanillaDeSueldos : Form
    {
        ...
        NpgsqlConnection conexion = new NpgsqlConnection("server=localhost;User Id=postgres; password=admin;Database=bdplanilla");
        ...
        private void btnGenerarR_Click(object sender, EventArgs e)
        {
            ...
            System.Drawing.Bitmap bm = new System.Drawing.Bitmap("C:/Users/German/Documents/logo.png");
            byte[] ba;
            ...
            // estilo.Font.Bold = true;
            sl.SetCellValue("I3", "CORRESPONDIENTE AL MES M DE A");
            ...
            style.Fill.SetPattern(DocumentFormat.OpenXml.Spreadsheet.PatternValues.Solid, System.Drawing.Color.DarkOrange, System.Drawing.Color.DarkOrange);
